...
- ✅ Generates a scannable QR code for `http://<your-ip>`
- ✅ Simple GUI with:
...
Build the `.exe`:
```bash
pyinstaller --noconsole --onefile --add-data "templates;templates" gui_server.py
```
...
├── gui_server.py         # Main launcher logic
├── templates/
